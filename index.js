...
switch(newValue){
  case -270:
  document.querySelector(".projecto1").setAttribute("tabindex", "-1");
  document.querySelector(".project1-container").setAttribute("aria-hidden",true);
  document.querySelector(".projecto4").setAttribute("tabindex");
  document.querySelector(".project4-container").removeAttribute("aria-hidden");
  break;
  case -540:
  document.querySelector(".projecto2").setAttribute("tabindex", "-1");
  document.querySelector(".project2-container").setAttribute("aria-hidden",true);
  document.querySelector(".projecto5").setAttribute("tabindex");
...
function clickLeft() {
  ...
  switch(newValue){
    case -270:
    document.querySelector(".projecto5").setAttribute("tabindex", "-1");
    document.querySelector(".project5-container").setAttribute("aria-hidden",true);
    document.querySelector(".projecto2").setAttribute("tabindex");
    document.querySelector(".project2-container").removeAttribute("aria-hidden");
 
      break;
    case -540:
    document.querySelector(".projecto4").setAttribute("tabindex", "-1");
    document.querySelector(".project4-container").setAttribute("aria-hidden",true);
    document.querySelector(".projecto1").setAttribute("tabindex");
...
/**Validad el formulario antes de mostar la notificacion */
function validateForm(e){
e.preventDefault();
const nameField=documnt.getElementById("name");
if(nameField=""){
...
function showNotification() {
  ...
  document.querySelector(".notification").innerHTML="El formulario se envio con exito";
